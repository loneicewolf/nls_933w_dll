...
<details><summary> Click to Expand - organized </summary>
  ...
  Please see the [ONLY_MALWARE](https://github.com/loneicewolf/nls_933w_dll/tree/ONLY_MALWARE) branch for the malware-only.
  * 💭 _interesting side note_ ~ I have noticed I am more organized if I make these 'sub branches' containing *only* the malware, packed and the archive's name is `ALL_PROVIDED.zip`, with password `infected`

</details>


<details><summary> Click to Expand -  un-organized </summary>
